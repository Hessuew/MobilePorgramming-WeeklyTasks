...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<NimiJaPvm> getAllData() {
        ArrayList<NimiJaPvm> po_list = new ArrayList<NimiJaPvm>();
        ...
        while (cursor.moveToNext()) {
            ...
            NimiJaPvm po = new NimiJaPvm(cursor.getString(1), cursor.getString(2));
            po_list.add(po);
        }
