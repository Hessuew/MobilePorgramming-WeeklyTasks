...
public class playerAdapter extends ArrayAdapter<NimiJaPvm> {

    private int line_layout;
    private LayoutInflater inflater;
    private ArrayList<NimiJaPvm> players;

    public playerAdapter(@NonNull Context context, int resource, ArrayList<NimiJaPvm> objects) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        NimiJaPvm po = players.get(position);
